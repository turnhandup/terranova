...
<html ng-app="architector_create">
<head>
    <!---METADATA--->
    <meta charset="UTF-8">
    ...
    <%--<script type="text/javascript" src="../../resources/js/orderer/ordererEdit.js"></script>--%>
...
<div class="registerblock center col-sm-10 col-md-7" ng-controller="architector_create_controller">
    <p>ORDERER EDITOR</p>
        <form class="form-horizontal" ng-submit="ordererCreate()" >
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8 col-md-6">
                    <input id="textinput" name="textinput" type="text" required ng-model="hours" class="form-control input-md">
                </div>
            </div>
            <div class="form-group">
                <label class=" col-xs-12 col-sm-4 control-label" for="textinput">Work experience</label>
                <div class="col-xs-12 col-sm-8 col-md-6">
                    <input id="textinput" name="textinput" type="text" ng-model="work_experience" class="form-control input-md">
                </div>
            </div>
            <div class="form-group">
...
<script src="../../../resources/js/admin/architectorCreate.js"></script>
</body>
</html>
