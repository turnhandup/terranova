    ...
    <div ng-controller="object_controller">
        <form class="form-horizontal" ng-submit="objectSave()" ng-controller="object_edit_control" >
            <div class="form-group">
                <label class=" col-xs-2 col-sm-2 control-label" for="textinput">STATUS</label>
                <div class="col-xs-6 col-sm-6 col-md-5">
                    <select class="form-control" ng-model="objects.status"  >
                        <option value="" ng-if="false"></option>
                        <option ng-selected="objects.status==item.value"
